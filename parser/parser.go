...
const (
	_ int = iota // eats 0 value for the first incremented costant
	LOWEST
	EQUALS
	LESSGREATER
	SUM
...
type (
	...
	// Binary expressions. Takes in the left side
...
func New(l *lexer.Lexer) *Parser {
	...
	p.infixParseFns = make(map[token.TokenType]infixParseFn) // wouldn't this have a known size?
...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	// TODO: we're skipping expressions until we get a semicolon
